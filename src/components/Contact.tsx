        ...
        <div className="contact-grid">
          ...
          <aside className="contact-info">
            <p className="info-intro">
              I'm a full-stack developer with expertise in React, PHP, and digital banking systems.
              Whether you need a web application, backend development, or technical consulting — I'm ready to help bring your ideas to life.
            </p>

            <ul className="info-details" role="list">
              {[
                { icon: <EmailIcon />,      label: "Email",    value: "emzomatewere@gmail.com", href: "mailto:emzomatewere@gmail.com" },
                { icon: <PhoneIcon />,      label: "Phone",    value: "(+265) 88 294 4267", href: "tel:+265882944267" },
                { icon: <LocationOnIcon />, label: "Location", value: "Blantyre, Malawi",           href: null },
